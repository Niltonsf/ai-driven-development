...
import { Boxes, CreditCard, Fingerprint, LayoutDashboard } from 'lucide-react';
...
const NAVIGATION_SECTIONS: SidebarMenuSection[] = [
  {
    ...
    items: [{ id: 'dashboard', label: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, match: 'prefix' },
      { id: 'auth', label: 'Autenticação', href: '/auth', icon: Fingerprint, match: 'prefix' },
      { id: 'contas', label: 'Contas', href: '/contas', icon: Boxes, match: 'prefix' },
      { id: 'cartao', label: 'Cartões', href: '/cartao', icon: CreditCard, match: 'prefix' },
    ],
  },
];
