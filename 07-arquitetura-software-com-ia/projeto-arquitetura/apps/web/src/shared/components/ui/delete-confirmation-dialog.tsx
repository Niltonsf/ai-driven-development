...
export function DeleteConfirmationDialog({
  ...
  // Limpa o texto sempre que o diálogo fecha — inclusive em fechamentos
  // programáticos (ex.: após confirmar), que não passam por `handleOpenChange`.
  // Ajuste de estado durante a renderização ao detectar a transição de `open`.
