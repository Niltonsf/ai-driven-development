...
// Hook de dados da exclusão de um cartão.
//
...
import { excluirCartao } from './cartoes.client';

export type UseExcluirCartaoResult = {
  isExcluindo: boolean;
...
export function useExcluirCartao(): UseExcluirCartaoResult {
