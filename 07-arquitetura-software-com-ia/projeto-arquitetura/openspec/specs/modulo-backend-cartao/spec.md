# modulo-backend-cartao Specification

## Purpose

Camada de backend do módulo Cartão: persistência Prisma, seed, adapter de repositório, queries CQRS de leitura, controller HTTP, wiring do módulo Nest e testes de integração.
