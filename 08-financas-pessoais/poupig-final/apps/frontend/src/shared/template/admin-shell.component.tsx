...
type AdminShellProps = {
  sidebar: ReactNode;
  children: ReactNode;
  /** Optional content rendered in the header right after the sidebar toggle (filled by the layout). */
                ...
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="h-auto gap-2 px-2.5 py-1.5">
                    {resolvedAvatarUrl ? (
                      ...
                      <span className="flex size-8 items-center justify-center rounded-full border border-border bg-muted text-xs font-semibold text-muted-foreground uppercase">
                        {userName
                          .split(' ')
                          .slice(0, 2)
