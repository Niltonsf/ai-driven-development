...
- **THEN** o menu mostra o grupo principal, depois "Cadastros" e, por último, "Extras" com o item "Desenvolvimento"
...
- **THEN** não há seção "Extras" nem item "Desenvolvimento", e as demais seções aparecem inalteradas
