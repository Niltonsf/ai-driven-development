# prisma-setup Specification

## Purpose

Configure Prisma infrastructure in the NestJS backend, with Docker Compose and `.env` referencing the `poupig` project, without running migrations.
