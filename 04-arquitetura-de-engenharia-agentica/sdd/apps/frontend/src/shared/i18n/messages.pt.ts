export const errorMessagesPt = {
  ...
  'user.email.already_registered': 'Este e-mail já está cadastrado.',
  'user.password.required': 'A senha é obrigatória.',
  'user.password.strong.password': 'A senha deve ter pelo menos 8 caracteres, com maiúscula, minúscula, número e símbolo.',
  'user.credentials.invalid': 'E-mail ou senha inválidos.',
  'user.not_found': 'Usuário não encontrado.',
  'user.password.confirmation_mismatch': 'A senha e a confirmação não coincidem.',
  'product.not_found': 'Produto não encontrado.',
  'product.name.required': 'O nome do produto é obrigatório.',
  'product.name.min.length': 'O nome do produto deve ter pelo menos 2 caracteres.',
